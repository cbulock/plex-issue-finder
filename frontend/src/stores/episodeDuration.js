...
const STORAGE_KEY = 'plex-episode-duration-results'
...
function saveToStorage(result, lastRun) {
  try {
    ...
    console.warn('[EpisodeDuration] Could not persist results to localStorage:', e.message)
  }
}

export const useEpisodeDurationStore = defineStore('episodeDuration', () => {
